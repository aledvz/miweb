# Generated by Django 2.2.1 on 2019-05-08 06:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='project',
            options={'ordering': ['-created'], 'verbose_name': 'proyecto', 'verbose_name_plural': 'proyecto'},
        ),
        migrations.AddField(
            model_name='project',
            name='link',
        ...
        migrations.AlterField(
            model_name='project',
            name='description',
            field=models.TextField(verbose_name='Decripcion'),
        ),
        migrations.AlterField(
            model_name='project',
            name='image',
